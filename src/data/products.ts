...
export const productFamilies: ProductFamily[] = [
  {
    ...
    longDescription: {
      pt: "Família de ligas de cobre com 9–14% de alumínio (com adição de ferro) que alcança resistência mecânica comparável a aços de médio carbono, mantendo excelente resistência à corrosão e ao desgaste em ambientes marinhos.",
      en: "Family of copper alloys with 9–14% aluminum (plus iron) reaching mechanical strength comparable to medium-carbon steel while keeping excellent corrosion and wear resistance in marine environments.",
    },
    characteristics: bi(
      [
        "Alumínio 9–14% e ferro ~4% para reforço estrutural",
        "Resistência comparável ao aço de médio carbono",
        "Resistência excepcional à corrosão marinha",
    ...
    alloys: [
      {
        ...
        description: {
          pt: "Liga de cobre-zinco-alumínio-manganês de alta resistência, equilibrando dureza, ductilidade e resistência à corrosão para componentes mecânicos críticos.",
          en: "High-strength copper-zinc-aluminum-manganese alloy balancing hardness, ductility, and corrosion resistance for critical mechanical components.",
        },
      ...
      },
      {
        ...
        astm: ["ASTM B505"],
        description: {
          pt: "Bronze de alto alumínio (12,5–13,5%) com altíssima resistência à compressão, projetado para buchas-guia, placas de desgaste e operações sem lubrificação contínua.",
          en: "High-aluminum bronze (12.5–13.5%) with very high compressive strength, designed for guide bushings, wear plates, and operations without continuous lubrication.",
        },
        image: "/images/alloys/bm-300.png",
        composition: [
          { element: el.copper, range: "Remainder" },
          { element: el.aluminum, range: "12.5–13.5%" },
          { element: el.iron, range: "3.0–5.0%" },
          { element: el.manganese, range: "máx. 1.5%" },
          { element: el.nickel, range: "máx. 0.5%" },
        ],
        properties: [
          { label: prop.tensile, value: "724–758", unit: "MPa" },
          { label: prop.yield, value: "407–420", unit: "MPa" },
          { label: prop.elongation, value: "0.5–1.5", unit: "%" },
          { label: prop.hardnessRockwellC, value: "28–32" },
        ...
        applications: bi(
          ["Buchas-guia em substituição a aço temperado", "Placas de desgaste", "Anéis de desgaste em estampos", "Roletes de conformação", "Aplicações a seco (substituto do bronze grafitado)"],
          ["Guide bushings replacing hardened steel", "Wear plates", "Wear rings in stamping dies", "Forming rollers", "Dry-running service (graphite bronze substitute)"],
        ),
      ...
      },
      {
        ...
        astm: ["ASTM B505"],
        description: {
          pt: "Variação da BM 300 com perfil de resistência calibrado para operações de conformação de tubos e roletes de dobra sem impacto.",
          en: "BM 300 variant tuned for tube-forming, bending rollers, and similar non-impact operations.",
        },
        ...
        applications: bi(
          ["Buchas-guia e placas de desgaste", "Anéis de desgaste em estampos e insertos", "Roletes formadores", "Operações de dobra e calandragem"],
          ["Guide bushings and wear plates", "Wear rings in stamping dies and inserts", "Forming rollers", "Bending and rolling operations"],
        ),
      ...
      },
      {
        ...
        description: {
          pt: "Liga de estrutura dúplex (13,5–14% Al) com resistência à compressão de 1.230–1.351 MPa, otimizada para mandris de conformação e ferramental de embutimento.",
          en: "Duplex-structure alloy (13.5–14% Al) with 1,230–1,351 MPa compressive strength, optimized for forming mandrels and drawing tools.",
        },
        image: "/images/alloys/bm-340.png",
        composition: [
          { element: el.copper, range: "Remainder" },
          { element: el.aluminum, range: "13.5–14.0%" },
          { element: el.iron, range: "4.5–5.0%" },
          { element: el.manganese, range: "2.0–2.3%" },
          { element: el.nickel, range: "máx. 0.5%" },
          { element: el.cobalt, range: "máx. 0.5%" },
          { element: el.others, range: "máx. 0.5%" },
        ],
        properties: [
          { label: prop.tensile, value: "586–724", unit: "MPa" },
          { label: prop.yield, value: "427–531", unit: "MPa" },
          { label: prop.elongation, value: "0.0–0.5", unit: "%" },
          { label: prop.hardnessRockwellC, value: "32–36" },
          { label: prop.compressive, value: "1230–1351", unit: "MPa" },
          { label: prop.density, value: "7.10", unit: "kg/dm³" },
        ],
        formats: bi(["Tarugo", "Usinado", "Placa"], ["Billet", "Machined", "Plate"]),
        applications: bi(
          ["Mandris e cilindros de conformação de tubos", "Matrizes de embutimento profundo", "Buchas extratoras", "Machos para moldes plásticos", "Componentes com alta resistência ao desgaste e compressão"],
          ["Tube-forming mandrels and rollers", "Deep-drawing dies", "Extractor bushings", "Plastic mold cores", "Components requiring high wear and compression resistance"],
        ),
        processes: bi(["Extrusão", "Forjamento"], ["Extrusion", "Forging"]),
      },
    ],
    applications: bi(
      ["Engrenagens, buchas e mancais de carga", "Componentes navais e offshore", "Bombas, impulsores e válvulas", "Placas e roletes de desgaste", "Equipamentos de dessalinização"],
      ["Gears, load bushings, and bearings", "Naval and offshore components", "Pumps, impellers, and valves", "Wear plates and rollers", "Desalination equipment"],
    ),
  },
  {
    ...
    alloys: [
      {
        ...
        thermalElectrical: [
          { label: prop.electrical, value: "18–82", unit: "%IACS" },
